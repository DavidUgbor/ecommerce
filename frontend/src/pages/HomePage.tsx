        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-wrap items-center justify-center gap-8 text-center">
            {[
              ...
              { icon: RefreshCw, text: '7-day exchanges' },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[480px]">
            ...
            <div className="relative min-h-[320px] lg:min-h-0 overflow-hidden">
              <img
                src="https://images.pexels.com/photos/14447086/pexels-photo-14447086.jpeg?auto=compress&cs=tinysrgb&w=1000"
            ...
            <div className="flex items-center px-8 sm:px-12 lg:px-16 py-14 bg-ink">
              <div className="max-w-sm">
                ...
                <p className="text-white/70 text-sm leading-relaxed mb-6">
                  I make leather goods in Surulere, Lagos. Every piece — from bags and shoes to wallets and sandals — is cut, stitched, and finished by my own hands. I work only with high-quality leather that ages beautifully and lasts for years. Just real leather, made right.
                </p>
