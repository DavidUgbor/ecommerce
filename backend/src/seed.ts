...
const products = [
  ...
  // Sandals
  {
    ...
    featured: true,
    images: [
      'https://images.pexels.com/photos/31129841/pexels-photo-31129841.jpeg?auto=compress&cs=tinysrgb&w=800',
    ],
    variants: [
  ...
  // Accessories
  {
    ...
    variants: [
      ...
      { type: 'SIZE', value: '22mm', stock: 45, priceModifier: 5000 },
    ],
  },
  {
    ...
    variants: [
      ...
      { type: 'SIZE', value: 'iPhone 15 Pro', stock: 20, priceModifier: 5000 },
      { type: 'SIZE', value: 'Samsung S24', stock: 15, priceModifier: 0 },
      { type: 'SIZE', value: 'Samsung S24+', stock: 15, priceModifier: 5000 },
    ],
  },
  {
